...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("NAUTOBOT_DB_PASSWORD", "password"),  # Database password
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "$9x+_-=*##6^oo$buxtmab31z#&so#71ioq1@61p44+cd7gl#2")
...
INTERNAL_IPS = ("127.0.0.1", "::1", "192.168.0.113",'192.168.0.152')
